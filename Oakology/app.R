              ...
              tabPanel(h5("Summary"),
                       ...
                       mainPanel(
                         tabsetPanel(
                           tabPanel("Project Overview",
                                    ...
                                    p("Our clients, The Nature Conservancy and the Santa Barbara Botanic Garden, are 
                                      ...
                                      account the wide uncertainty in projections of future climate. Managers can use 
                                      our comprehensive analysis in conjunction with prior known information about the 
                                      species to inform adaptive management planning on the islands to best conserve 
                                      and protect the species under climate change."),
                                    h3("Objectives"),
                                    ...
                                    br(),
                                    p("Ultimately, our hope is that island managers can use this comprehensive analysis 
                                      in conjunction with prior known information about island oak to inform adaptive 
                                      management planning on the islands and to best conserve and protect the species under 
                                      climate change. Furthermore, the methodology was developed throughout the process for 
                                      application to other endemic and threatened species of interest on the CAIA in the future.")
                                    ),
                           tabPanel("Data", 
                                    br(),
                                    ...
                                    p(em("Photo: Denise Knapp")),
                                    h3("Overview"),
                                    p("We performed analyses of how climate change will likely impact island oak presence across 
                                      the CAIA. These analyses required oak presence points, present climate data, future climate
                                    ...
                                    p("Presence data for both Santa Cruz and Santa Rosa were collected from 2003 – 2004, 2006 – 2007, 
                                      ...
                                      of individual trees, groups of trees, and entire groves. Age information for trees 
                                    ...
                                    p("We obtained island specific data from various island managers and sources, including 
                                      ...
                                      Conservancy). We ultimately did not include any of these layers in the model, 
                                    ...
                                    p("The constant fog scenario acts as a control. The decreasing fog accounts for the possible 
                                      ...
                                      reported in the literature, as measured by stations at San Nicolas Island 
                                      ...
                                      increase in fog occurrence trends measured at San Nicolas (Williams et all, 2015). 
                           ...
                           tabPanel("Methodology",
                                    ...
                                    p("We used MaxEnt species distribution modeling software to determine which of the available 
                                      environmental variables were the most influential for predicting the island oak’s niche by
                         ...
                         tabPanel("Tab Summary",
                                  ...
                                  p(em("Photo: Denise Knapp")),
                                  em("This section provides a very detailed explanation of what can be found and
                                  ...
                                  p("The summary tab provides essential information on the project background, 
                                    ...
                                    as a reference for the other slides."),
                                  h3("Oaks"),
                                  p("The oak tab displays the island oak presence points on both islands. 
                                    ...
                                    age structure information explorable for a subset of its points, so users can 
                                    choose the colors and visualize which of the oak points are known adults and 
                                    which are known seedlings. These are shown in color on top of the rest of the 
                                    oaks on the island, including those without known age information, represented 
                                  ...
                                  p("The fog tab visualizes the probability of fog inundation across the islands. Users can select 
                                    ...
                                    to an elevational threshold."),
                                  h3("SDM"),
                                  p("The SDM tab provides results from the species distribution model (SDM) analyses for the island oak.
                                  ...
                                  p("The top panel displays the SDM results for the historic time period (1981 – 2010), showing the
                                    current predicted distribution of the species is on Santa Cruz and Santa Rosa. Users can 
                                  ...
                                  p("The bottom panel displays the SDM results for future projections, and can be visualized
                                    ...
                                    variety of color palettes. If the ‘no fog’ option is selected in historic, then 
                                    ‘no fog’ would be the best choice to visualize for the projected option to make an 
                                  ...
                                  p("The tables underneath each map are updated based on the selection of historic or future
                                    ...
                                    urve (AUC) metric, highest predicted suitability value, and percent of the island deemed 
                                    suitable for island oak climate habitat under each scenario. In the projected table, the 
                                    percent change in predicted suitable habitat compared to the historic scenario is provided.
                                    AUC values are metrics of model fit and model predictive power, and range from 0-1, with a 
                                    value close to 1 meaning that errors are minimized with regards to false positives and 
                                    ...
                                    of the island deemed as suitable island oak habitat under each scenario. This calculation 
